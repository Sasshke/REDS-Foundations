...
export const typography = {
  ...
  subhead: {
    ...
    tablet: { fontSize: 24, lineHeight: 32, fontWeight: fontWeights.bold, letterSpacing: 0 },
    mobile: { fontSize: 20, lineHeight: 28, fontWeight: fontWeights.bold, letterSpacing: 0 },
  },
