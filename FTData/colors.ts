...
export const darkColors = {
  ...
  accent: {
    ...
    leadSurface: {
      enabled: rgba(palette.indigo[75]),
      hover: rgba(palette.indigo[70]),
      active: rgba(palette.indigo[65]),
      contrast: palette.indigo[20],
      alt: palette.indigo[50],
    },
    leadContainer: {
      enabled: rgba(palette.indigo[50]),
      hover: rgba(palette.indigo[65]),
      active: rgba(palette.indigo[60]),
