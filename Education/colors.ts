...
export const darkColors = {
  ...
  accent: {
    lead: {
      enabled: palette.purple[35],
      hover: palette.purple[40],
      active: palette.purple[45],
      contrast: palette.purple[80],
      alt: palette.purple[60],
    },
    leadSurface: {
      enabled: rgba(palette.purple[75]),
      hover: rgba(palette.purple[70]),
      active: rgba(palette.purple[65]),
      contrast: palette.purple[20],
      alt: palette.purple[50],
    },
    leadContainer: {
      enabled: rgba(palette.purple[50]),
      hover: rgba(palette.purple[65]),
      active: rgba(palette.purple[60]),
      contrast: palette.purple[10],
      alt: palette.purple[30],
    },
    success: {
    ...
    successSurface: {
      enabled: rgba(palette.green[75]),
      hover: rgba(palette.green[70]),
      active: rgba(palette.green[65]),
      contrast: palette.green[20],
      alt: palette.green[50],
    },
    successContainer: {
      enabled: rgba(palette.green[50]),
      hover: rgba(palette.green[65]),
      active: rgba(palette.green[60]),
    ...
    infoSurface: {
      enabled: rgba(palette.blue[75]),
      hover: rgba(palette.blue[70]),
      active: rgba(palette.blue[65]),
      contrast: palette.blue[20],
      alt: palette.blue[50],
    },
    infoContainer: {
      enabled: rgba(palette.blue[50]),
      hover: rgba(palette.blue[65]),
      active: rgba(palette.blue[60]),
    ...
    warningSurface: {
      enabled: rgba(palette.orange[75]),
      hover: rgba(palette.orange[70]),
      active: rgba(palette.orange[65]),
      contrast: palette.orange[20],
      alt: palette.orange[50],
    },
    warningContainer: {
      enabled: rgba(palette.orange[50]),
      hover: rgba(palette.orange[65]),
      active: rgba(palette.orange[60]),
    ...
    errorSurface: {
      enabled: rgba(palette.red[75]),
      hover: rgba(palette.red[70]),
      active: rgba(palette.red[65]),
      contrast: palette.red[20],
      alt: palette.red[50],
    },
    errorContainer: {
      enabled: rgba(palette.red[50]),
      hover: rgba(palette.red[65]),
      active: rgba(palette.red[60]),
    ...
    neutralSurface: {
      enabled: rgba(palette.neutral[80]),
      hover: rgba(palette.neutral[75]),
      active: rgba(palette.neutral[70]),
      contrast: palette.neutral[20],
      alt: palette.neutral[50],
    },
    neutralContainer: {
      enabled: rgba(palette.neutral[60]),
      hover: rgba(palette.neutral[55]),
      active: rgba(palette.neutral[50]),
      contrast: palette.neutral[20],
      alt: palette.neutral[30],
    },
  },
